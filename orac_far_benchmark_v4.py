...
CHI2_NBINS   = 4
CHI2_P_THR   = 0.001
MAX_QUIET_SNR = 11.0    # strict: only very clean segments
...
QUIET_SEGMENTS = [
    # Verified clean (max SNR=0.00): O3a early epoch
    {"name": "O3a_q01", "gps_start": 1238166018, "detector": "L1", "duration": 4096},
    {"name": "O3a_q12", "gps_start": 1242578176, "detector": "L1", "duration": 4096},
    # Extended O3a — same clean epoch, step 4096s apart
    {"name": "O3a_q40", "gps_start": 1238170114, "detector": "L1", "duration": 4096},
    {"name": "O3a_q41", "gps_start": 1238174210, "detector": "L1", "duration": 4096},
    {"name": "O3a_q42", "gps_start": 1238178306, "detector": "L1", "duration": 4096},
    {"name": "O3a_q43", "gps_start": 1238182402, "detector": "L1", "duration": 4096},
    {"name": "O3a_q44", "gps_start": 1238186498, "detector": "L1", "duration": 4096},
    {"name": "O3a_q45", "gps_start": 1238190594, "detector": "L1", "duration": 4096},
    {"name": "O3a_q46", "gps_start": 1238194690, "detector": "L1", "duration": 4096},
    {"name": "O3a_q47", "gps_start": 1238198786, "detector": "L1", "duration": 4096},
    # O3a second clean epoch
    {"name": "O3a_q50", "gps_start": 1242582272, "detector": "L1", "duration": 4096},
    {"name": "O3a_q51", "gps_start": 1242586368, "detector": "L1", "duration": 4096},
    {"name": "O3a_q52", "gps_start": 1242590464, "detector": "L1", "duration": 4096},
    {"name": "O3a_q53", "gps_start": 1242594560, "detector": "L1", "duration": 4096},
    {"name": "O3a_q54", "gps_start": 1242598656, "detector": "L1", "duration": 4096},
    {"name": "O3a_q55", "gps_start": 1242602752, "detector": "L1", "duration": 4096},
    {"name": "O3a_q56", "gps_start": 1242606848, "detector": "L1", "duration": 4096},
    {"name": "O3a_q57", "gps_start": 1242610944, "detector": "L1", "duration": 4096},
    {"name": "O3a_q58", "gps_start": 1242615040, "detector": "L1", "duration": 4096},
    {"name": "O3a_q59", "gps_start": 1242619136, "detector": "L1", "duration": 4096},
]
...
def chi2_at_idx(w, tmpl, idx):
    ...
    edges = np.linspace(20, 500, CHI2_NBINS + 1)
    snr_bins = []
...
def run_benchmark():
    ...
    print("\n" + "=" * 62)
    print("  ORAC-NT v4.2 — FAR BENCHMARK")
    print(f"  {run_utc}")
    print("=" * 62)
    ...
    for seg in QUIET_SEGMENTS:
        ...
        if s is None:
            print(f"    [SKIP] No real GWOSC data.")
            continue
    ...
    if not quiet_cache:
        print("  [ERR] No clean quiet segments.")
        return [], []
    ...
    fig.suptitle(
        f"ORAC-NT v4.2  |  {detected_count}/{total_events} detected  "
        f"|  FAR={far_per_yr:.2e} /yr",
